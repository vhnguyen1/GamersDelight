...
class DBHelper extends SQLiteOpenHelper {
    ...
    public ArrayList<Game> getAllGames() {
        ...
        Cursor cursor = database.query(
                DATABASE_TABLE,
                new String[]{KEY_FIELD_ID, FIELD_NAME, FIELD_DESCRIPTION, FIELD_RATING,
                        FIELD_IMAGE_NAME},
                null,
                null,
                null, null, null, null );
        ...
        if (cursor.moveToFirst()){
            do {
                ...
                String gameDescription = cursor.getString(2);
                float gameRating = cursor.getFloat(3);
                String gameImageName = cursor.getString(4);

                //Game game = new Game(cursor.getInt(0), cursor.getString(1), cursor.getString(2),
                        //cursor.getFloat(3), cursor.getString(4));
                Game game = new Game(gameID, gameName, gameDescription, gameRating, gameImageName);
                gameList.add(game);
    ...
    public Game getGame(int id) {
        ...
        Game game = new Game(gameName, gameDescription, gameRating, gameImageName);
        db.close();
